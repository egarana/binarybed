...
class UpdateUnitRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'host.whatsapp' => ['nullable', 'array'],
            'host.whatsapp.country' => ['required_with:host.whatsapp', 'array'],
            'host.whatsapp.country.country' => ['required_with:host.whatsapp', 'string', 'size:2'],
            'host.whatsapp.country.countryName' => ['required_with:host.whatsapp', 'string', 'max:100'],
            'host.whatsapp.country.code' => ['required_with:host.whatsapp', 'string', 'max:10'],
            'host.whatsapp.number' => ['required_with:host.whatsapp', 'string', 'max:15'],
