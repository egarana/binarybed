    ...
    <header class="bg-background sticky top-0 z-50 w-full md:py-5 lg:py-7 md:backdrop-blur md:bg-card/75">
        <div class="mx-auto max-w-screen-xl flex items-center justify-between py-3 border-b md:px-6 md:py-0 md:justify-end md:border-b-0 md:gap-4">
            <div class="ps-6 md:ps-0 md:me-auto">
                <Link href="/">
                    <component :is="props.logo || AppLogoIcon" class="h-8 w-auto lg:h-10" />
                </Link>
            </div>
                ...
                <nav>
                    <ul class="flex items-center justify-between md:gap-6 md:justify-end">
                        ...
                        <li
                            ...
                            :key="item.href"
                            :class="[
                                { 'text-muted-foreground opacity-60 md:opacity-100 md:hover:text-primary': !shouldShowNavActive(item.href) },
                                { 'md:border-e md:pe-6': index === props.navItems.length - 1 }
                            ]"
                        >
                            <Link :href="item.href">
                                <div class="flex flex-col items-center gap-0.5">
