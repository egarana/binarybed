    ...
    <TenantLayout v-slot="{ tenant }" :title="'Experiences'">
        <div class="min-h-dvh p-8">
            <div class="max-w-6xl mx-auto">
                <h1 class="text-3xl font-bold mb-2">Villa Experiences</h1>
                <p class="text-gray-600 dark:text-gray-400 mb-8">
                    Romantic and exclusive experiences at {{ tenant.name }}
                </p>
                    ...
                    >
                        ...
                        <div class="p-6">
                            ...
                            <Link 
                                ...
                                class="inline-block px-4 py-2 bg-pink-500 hover:bg-pink-600 text-white rounded-lg text-sm transition-colors"
                            >
                                Learn More →
                            </Link>
                        </div>
