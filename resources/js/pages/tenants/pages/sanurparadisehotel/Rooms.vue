...
<template>
    <TenantLayout v-slot="{ tenant }" :title="'Rooms'">
        <div class="min-h-dvh p-8">
            <div class="max-w-6xl mx-auto">
                <h1 class="text-3xl font-bold mb-2">Our Rooms & Suites</h1>
                <p class="text-gray-600 dark:text-gray-400 mb-8">
                    Comfortable accommodations at {{ tenant.name }}
                </p>
                    ...
                    >
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-500 dark:text-gray-400 text-sm mb-4">
                                Stay in our {{ item.name.toLowerCase() }}
                            </p>
                            <Link 
