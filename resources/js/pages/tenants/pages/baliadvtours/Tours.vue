...
<template>
    <TenantLayout v-slot="{ tenant }" :title="'Tours'">
        <div class="min-h-dvh p-8">
            <div class="max-w-6xl mx-auto">
                <h1 class="text-3xl font-bold mb-2">Adventure Tours</h1>
                <p class="text-gray-600 dark:text-gray-400 mb-8">
                    Explore Bali with {{ tenant.name }}
                </p>
                    ...
                    >
                        ...
                        <div class="p-6">
                            ...
                            <Link 
                                ...
                                class="inline-block px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg text-sm transition-colors"
                            >
                                Book Tour →
                            </Link>
                        </div>
                ...
                <div v-if="resources.length === 0" class="text-center py-16">
                    <p class="text-gray-500">No tours available at this time.</p>
                </div>
            </div>
        </div>
    </TenantLayout>
