...
<template>
    <TenantLayout v-slot="{ tenant }" :title="'Services'">
        <div class="min-h-dvh p-8">
            <div class="max-w-6xl mx-auto">
                <h1 class="text-3xl font-bold mb-2">MICE Services</h1>
                <p class="text-gray-600 dark:text-gray-400 mb-8">
                    Premium event services at {{ tenant.name }}
                </p>
                    ...
                    >
                        ...
                        <div class="p-6">
                            ...
                            <Link 
                                ...
                                class="inline-block px-4 py-2 bg-sky-500 hover:bg-sky-600 text-white rounded-lg text-sm transition-colors"
                            >
                                Learn More →
                            </Link>
                        </div>
