...
<template>
    <TenantLayout v-slot="{ tenant }" :title="'Programs'">
        <div class="min-h-dvh p-8">
            <div class="max-w-6xl mx-auto">
                <h1 class="text-3xl font-bold mb-2">Wellness Programs</h1>
                <p class="text-gray-600 dark:text-gray-400 mb-8">
                    Transform your wellbeing with {{ tenant.name }}
                </p>
                    ...
                    >
                        ...
                        <div class="p-6">
                            ...
                            <Link 
                                ...
                                class="inline-block px-4 py-2 bg-teal-500 hover:bg-teal-600 text-white rounded-lg text-sm transition-colors"
                            >
                                Join Program →
                            </Link>
                        </div>
                ...
                <div v-if="resources.length === 0" class="text-center py-16">
                    <p class="text-gray-500">No programs available at this time.</p>
                </div>
            </div>
        </div>
    </TenantLayout>
