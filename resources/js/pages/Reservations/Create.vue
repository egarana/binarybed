...
const disabledDates = ref<string[]>(Array.isArray(usePage().props.disabledDates) 
...
watch(selectedUnit, (newVal) => {
    ...
    if (newVal) {
        ...
        // Fetch disabled dates for this unit
        router.get(route('reservations.create'), {
    ...
    // 🔥 Always reset check-in & check-out
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-x-auto">
            <div class="flex flex-col space-y-6 min-h-full">
                <HeadingSmall title="Create reservation" description="Manually create a new reservation for a unit and assign the appropriate rate" />
