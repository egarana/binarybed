...
Beyond the cabin, adventure awaits just a stone's throw away. Explore the nearby pine forests, take a dip in the natural hot springs, or embark on a sunrise trek to the summit of Mount Batur. For those who prefer a slower pace, simply relax by the fire pit in the evening, sharing stories under a canopy of stars. Rahajeng Cabin isn't just a place to stay; it's an experience that reconnects you with the beauty of the earth and the peace within yourself.",
                ...
                'book_direct_benefits' => [
                    ['icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"  stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-tag"><path d="M12 2H2v10l9.29 9.29c.94.94 2.48.94 3.42 0l6.58-6.58c.94-.94.94-2.48 0-3.42L12 2Z"/><path d="M7 7h.01"/></svg>', 'title' => 'Best Price Guarantee', 'description' => 'Save 10% vs OTA prices'],
                    ['icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"  stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-coffee"><path d="M17 8h1a4 4 0 1 1 0 8h-1"/><path d="M3 8h14v9a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4Z"/><line x1="6" x2="6" y1="2" y2="4"/><line x1="10" x2="10" y1="2" y2="4"/><line x1="14" x2="14" y1="2" y2="4"/></svg>', 'title' => 'Free Breakfast', 'description' => 'Daily local breakfast included'],
                ],
                'location' => [
